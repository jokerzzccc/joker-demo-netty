...
# joker-demo-netty-2-03

- 主题：netty案例，netty4.1中级拓展篇三《Netty传输Java对象》
...
# joker-demo-netty-2-04

- 主题：netty案例，netty4.1中级拓展篇四《Netty传输文件、分片发送、断点续传》
...
1. 启动 NettyServerTest
2. 启动 NettyClientTest





# joker-demo-netty-2-05

- 主题：netty案例，netty4.1中级拓展篇五《基于Netty搭建WebSocket，模仿微信聊天页面》
...
1. 开始
2. 启动 SpringBoot
3. 打开网页websocket客户端；http://localhost:8080/index
4. 在网页端，输入消息，查看服务端日志结果
5. 结束
