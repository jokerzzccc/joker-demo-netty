...
import com.joker.demo.netty.domain.Constants;
import com.joker.demo.netty.domain.FileBurstData;
...
/**
 * <p>
 * 文件客户端；channelRead处理文件协议，其中模拟传输过程中断，场景测试可以注释掉
 * </p>
 *
 * @author jokerzzccc
 * @since 2023/9/13
        ...
        switch (fileTransferProtocol.getTransferType()) {
            case 1:
                ...
                System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())
                        + " joker 客户端传输文件信息。 FILE：" + fileBurstData.getFileName()
